...
from .utils import parse_gpsc, download_fsaverage
...
def lcmv_beamformer(raw, ch_pos, project_base, subject_id, task, 
    ...
    if not (bem_file.exists() and src_file.exists()):
        raise FileNotFoundError(
            "Missing fsaverage resources. Run:\n"
            "  from lcmv_xtra.utils import download_fsaverage\n"
            f"  download_fsaverage('{project_base}')"
        )    
